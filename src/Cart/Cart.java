...
public class Cart extends javax.swing.JFrame {
    ...
    private void CheckoutButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckoutButtonActionPerformed
        if(Double.parseDouble(TotalTextField.getText()) == 0) {
            JOptionPane.showMessageDialog(this, "Cart anda masih kosong, silahkan pilih item yang ingin anda beli!", "ERROR", JOptionPane.ERROR_MESSAGE);
        } else {
            InsertIntoSalesTable();
            UpdateInventoryTable();
            DropShoppingCartTable();
            ResetTotals();
            JOptionPane.showMessageDialog(this, "Checkout berhasil. Items sedang dalam perjalanan", "SUCCESS", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void CreateTable() {
        ...
        try {
            PreparedStatement st = dbconn.prepareStatement("CREATE TABLE IF NOT EXISTS " + username + "_cart AS SELECT id, name, price, quantity FROM products LIMIT 0" );
    ...
    public void AddToCart(int itemId, String itemName, double itemPrice, int quantity) {
        ...
        try {
            PreparedStatement st = dbconn.prepareStatement("INSERT INTO " + this.getTableName() + " (id, name, price, quantity) VALUES (?, ?, ?, ?)");
    ...
    public void UpdateInventoryTable() {
        ...
        try {
                for (Map.Entry<Integer, Integer> item : my_dict.entrySet()) {    
                    PreparedStatement st = dbconn.prepareStatement("UPDATE products SET quantity = (quantity - ?) WHERE id = ?");
